...
import { useGetMyProductsQuery } from '../../services/postApi'
...
const MyProducts = () => {
    ...
    let {data:posts,isLoading,isError,error} = useGetMyProductsQuery()
  ...
  return (
    <div className='w-[90vw] h-[100vh] m-auto'>
        ...
        <div className='p-5 m-auto w-[100%] max-[500px]:w-[100%] '>
            <h1 className='font-bold text-[18px]'>My products :</h1>
            <hr className='my-2'/>
